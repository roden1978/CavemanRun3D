...
{
    public class PauseMenuInitSystem : IEcsInitSystem, IEcsRunSystem
    {
        ...
        private EcsPool<IsPauseMenu> _closeBtnObjectPool;
        
        
        public void Init(IEcsSystems systems)
        {
            _world = systems.GetWorld();
            _filter = _world.Filter<IsPauseMenu>().Inc<ScriptableObjectComponent>().End();
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            {
                if (_scriptableObjectPool.Get(entity).Value is UIPauseMenuData dataInit)
                {
